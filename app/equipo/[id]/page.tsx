        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
              <div className="grid md:grid-cols-2 gap-8 p-8">
                {/* Imagen del producto */}
                <div className="h-[450px] bg-gradient-to-br from-purple-50 to-pink-50 rounded-xl flex items-center justify-center">
                  <Image
                    src={imagenUrl}
            ...
            <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-2xl p-8 border border-gray-200">
              <h2 className="text-2xl font-bold text-ofimundo-navy mb-6 text-center">
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
              ...
              <p className="text-lg font-bold text-ofimundo-navy mb-1">
                {equipo.Nombre_Marca || "Sin marca"}
              </p>
              <p className="text-sm text-gray-600">Modelo: {equipo.ID_Producto}</p>
            </div>
            ...
            {/* CTA adicional */}
            <div className="bg-gradient-to-br from-[var(--ofimundo-purple)] to-[var(--ofimundo-magenta)] rounded-xl p-6 text-white">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="block w-full text-center py-3 bg-white text-ofimundo-purple rounded-lg font-semibold hover:bg-gray-100 transition"
              >
                Contactar Asesor
              </a>
            </div>
