      ...
      <nav className="navbar">
        ...
        <ul className="nav-links">
          <li className="dropdown">
            ...
            <div className="mega-menu">
              ...
              <a
                href="https://www.ofimundo.cl/servicios/smart-office.html"
                target="_blank"
                rel="noopener noreferrer"
                className="mega-item"
              >
        ...
        <div className="nav-button">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="btn-account bg-gradient-to-br from-[var(--ofimundo-purple)] to-[var(--ofimundo-magenta)] text-white rounded-lg text-sm font-semibold hover:from-[#241a78] hover:to-[#c62842] transition"
          >
            MI CUENTA
          </a>
        </div>
