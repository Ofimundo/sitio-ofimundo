      ...
      <div className="max-w-7xl mx-auto">
        ...
        {verMasLink && (
          <div className="text-center mt-10">
            <Link
              href={verMasLink}
              className="inline-block px-8 py-3 bg-gradient-to-br from-[var(--ofimundo-purple)] to-[var(--ofimundo-magenta)] text-white rounded-lg font-semibold hover:from-[#241a78] hover:to-[#c62842] transition"
            >
